...
class SnakeCaseJsonSupportSpec extends Specification with SnakeCaseJsonSupport {
  ...
  "SnakeCaseJsonSupport" should {
    "convert field names to snake cased fields names." in {
      ...
      fields1 must haveKey ("a1a_ab_bbbb_bb_c_ccc")
      fields1 must haveKey ("ab_a_abb_aa_abbb_1aa_2bb_1aa2aaa_abb_1b_aa")
      fields1 must haveKey ("x")
      fields1 must haveKey ("y")
      fields1 must haveKey ("^_there_-ar_e__non_(_alphabetic_))_character_!s")
      fields1 must haveKey ("  _there_ are_ space_ character_ ")
      fields1 must haveKey (" これは　マルチバイト_abc_のa_bc_確認です。")
      ...
      fields2 must haveKey("aaa_123_bbb")
      fields2 must haveKey("aa_a123_bbb")
      fields2 must haveKey("aaa_12_3bbb")
      fields2 must haveKey("aa_a123_bbb")
      fields2 must haveKey("aaa_123")
